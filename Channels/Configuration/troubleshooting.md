...
| Group messages ignored | Check requireMention + mention patterns | Mention bot or relax mention policy for group |
| Random disconnect/relogin loops | openclaw channels status --probe + logs | Re-login and verify credentials directory healthy |
...
| Channel message ignored | Check groupPolicy and channel allowlist | Allow channel or switch policy to open |
